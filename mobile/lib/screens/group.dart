      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final isCharlie =
                      member['name'] == 'Charlie'; // Check if it's Charlie

                  return Card(
                    elevation: isLeader ? 6 : 2, // Elevate the leader card
                    shadowColor: isLeader
                        ? Colors.yellow
                        : Colors.grey, // Shadow color for the leader
                    ...
                    child: ListTile(
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              ...
                              color: isLeader
                                  ...
                                  : isCharlie
                                      ? Colors
                                          .deepOrange // Highlight Charlie's name
                                      : Colors.blue[
                                          800], // Different colors for other members
                            ),
                          ),
                          if (isLeader)
                            const Padding(
                              ...
                              child: Icon(
                                FontAwesomeIcons
                                    .crown, // Crown icon next to the leader's name
                                color: Colors.amber,
                                size: 24,
                              ),
                            ),
                      ...
                      subtitle: Text(
                        ...
                        style: TextStyle(
                          fontSize: 16,
                          fontWeight:
                              FontWeight.w600, // Bold subtitle for emphasis
                          color: isLeader
                              ? Colors.black
                              : isCharlie
                                  ? Colors
                                      .deepOrange // Highlight Charlie's points
                                  : Colors.grey[
                                      700], // Subtitle color for other members
                        ),
                      ),
                    ),
                  );
            ...
            // Container(
            //   padding:
            //       const EdgeInsets.all(16.0), // Added padding around the quote
            //   decoration: BoxDecoration(
            //     color: Colors
            //         .amberAccent, // Vibrant background color for the quote
